...
public interface IEmailService
{
    ...
    Task<Result> SendTutorialRequestScheduledEmail(List<EmailRecipient> recipients, Request tutorialRequest, string teamName, List<(string Period, string Teacher)> periods, CancellationToken cancellationToken = default);
