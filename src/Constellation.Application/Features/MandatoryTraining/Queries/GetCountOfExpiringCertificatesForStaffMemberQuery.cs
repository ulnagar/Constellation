...
public record GetCountOfExpiringCertificatesForStaffMemberQuery(string StaffId) : IRequest<int> { }

public class GetCountOfExpiringCertificatesForStaffMemberQueryHandler : IRequestHandler<GetCountOfExpiringCertificatesForStaffMemberQuery, int>
{
    private readonly IAppDbContext _context;

    public GetCountOfExpiringCertificatesForStaffMemberQueryHandler(IAppDbContext context)
    {
        _context = context;
    }

    public async Task<int> Handle(GetCountOfExpiringCertificatesForStaffMemberQuery request, CancellationToken cancellationToken)
    {
