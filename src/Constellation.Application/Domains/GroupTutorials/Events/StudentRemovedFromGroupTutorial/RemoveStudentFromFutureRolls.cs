namespace Constellation.Application.Domains.GroupTutorials.Events.StudentRemovedFromGroupTutorial;
...
internal sealed class RemoveStudentFromFutureRolls
    : IDomainEventHandler<StudentRemovedFromGroupTutorialDomainEvent>
{
    private readonly IGroupTutorialRepository _groupTutorialRepository;
    private readonly IUnitOfWork _unitOfWork;

    public RemoveStudentFromFutureRolls(
