...
public interface IEdvalRepository
{
    ...
    Task<int> CountIgnoredDifferences(CancellationToken cancellationToken = default);
    Task<Difference?> GetDifference(DifferenceId id, CancellationToken cancellationToken = default);
    ...
    Task<List<EdvalIgnore>> GetIgnoreRecords(EdvalDifferenceType? type, CancellationToken cancellationToken = default);
    ...
    void Insert(EdvalIgnore entity);
    void Remove(EdvalIgnore entity);
