...
internal sealed class CreateTutorialRequestCommandHandler
    :ICommandHandler<CreateTutorialRequestCommand>
{
    ...
    public CreateTutorialRequestCommandHandler(
        ...
        ILogger logger)
    {
        ...
        _logger = logger
            .ForContext<CreateTutorialRequestCommand>();
    }

    public async Task<Result> Handle(CreateTutorialRequestCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            _logger
                .ForContext(nameof(CreateTutorialRequestCommand), request, true)
