    ...
    : IQueryHandler<GetAbsenceNotificationDetailsQuery, string>
{
    ...
    public async Task<Result<string>> Handle(GetAbsenceNotificationDetailsQuery request, CancellationToken cancellationToken)
    {
        ...
        if (absence is null)
        {
            ...
            return Result.Failure<string>(AbsenceErrors.NotFound(request.AbsenceId));
        }
        ...
        if (notification is null)
        {
            ...
            return Result.Failure<string>(AbsenceNotificationErrors.NotFound(request.NotificationId));
        }
