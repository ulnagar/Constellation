...
public interface ISchoolContactRepository
{
    ...
    Task<List<SchoolContact>> GetPrincipalsForSchool(SchoolCode schoolCode, CancellationToken cancellationToken = default);
    Task<SchoolContact?> GetWithRolesByEmailAddress(EmailAddress emailAddress, CancellationToken cancellationToken = default);
    Task<List<SchoolContact>> GetWithRolesBySchool(SchoolCode schoolCode, CancellationToken cancellationToken = default);
    ...
    Task<List<SchoolContact>> GetActiveByRole(Position selectedRole, CancellationToken cancellationToken = default);
