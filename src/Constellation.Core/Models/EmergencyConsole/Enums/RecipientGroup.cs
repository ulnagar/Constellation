...
public sealed class RecipientGroup : StringEnumeration<RecipientGroup>
{
    ...
    public static readonly RecipientGroup AllTeachersOnClassNextBlock = new("AllTeachersOnClassNextBlock", "All Teachers on class next block", 4);
    ...
    public static readonly RecipientGroup AllACCsWithStudentsOnClassNextBlock = new("AllACCsOnClassNextBlock", "All ACCs with Students on class next block", 8);
    ...
    public static readonly RecipientGroup AllStudentsOnClassNextBlock = new("AllStudentsOnClassNextBlock", "All Students on class next block", 12);
    ...
    public static readonly RecipientGroup AllParentsOnClassNextBlock = new("AllParentsOnClassNextBlock", "All Residential Parents with Students on class next block", 16);
