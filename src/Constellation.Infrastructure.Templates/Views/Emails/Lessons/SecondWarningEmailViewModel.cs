...
public sealed class SecondWarningEmailViewModel : EmailLayoutBaseViewModel
{
    private const string _viewLocation = "/Views/Emails/Lessons/SecondWarningEmail.cshtml";
