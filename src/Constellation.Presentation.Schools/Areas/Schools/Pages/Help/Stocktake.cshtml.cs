...
public class StocktakeModel : BasePageModel
{
    ...
    public void OnGet()
    {
        _logger.Information("Requested to retrieve stocktake help page by user {user} for school {school}", _currentUserService.UserName, CurrentSchoolCode);
    }
}