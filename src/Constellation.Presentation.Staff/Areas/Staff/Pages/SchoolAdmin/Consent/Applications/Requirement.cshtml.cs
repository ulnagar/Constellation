...
public class RequirementModel : BasePageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        foreach (CourseId courseId in Courses)
        {
            ...
            if (result.IsFailure)
            {
                ...
                ModalContent = new ErrorDisplay(
                    result.Error,
                    _linkGenerator.GetPathByPage("/SchoolAdmin/Consent/Applications/Details", values: new { area = "Staff", Id }));
        ...
        return RedirectToPage("/SchoolAdmin/Consent/Applications/Details", new { area = "Staff", Id});
    }
