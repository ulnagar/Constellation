...
{
    public class AdobeConnectGatewayConfiguration : IAdobeConnectGatewayConfiguration, ITransientService
    {
        public AdobeConnectGatewayConfiguration(IUnitOfWork unitOfWork, IConfiguration configuration)
        {
