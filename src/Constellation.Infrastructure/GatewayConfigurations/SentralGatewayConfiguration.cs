...
{
    public class SentralGatewayConfiguration : ISentralGatewayConfiguration, ITransientService
    {
        public SentralGatewayConfiguration(IUnitOfWork unitOfWork, IConfiguration configuration)
        {
