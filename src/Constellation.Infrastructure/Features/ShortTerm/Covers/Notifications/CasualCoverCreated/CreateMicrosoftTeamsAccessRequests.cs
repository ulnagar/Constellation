...
{
    public class CreateMicrosoftTeamsAccessRequests : INotificationHandler<CasualCoverCreatedNotification>
    {
        ...
        public async Task Handle(CasualCoverCreatedNotification notification, CancellationToken cancellationToken)
        {
            ...
            var casualAddOperation = new CasualMSTeamOperation
            {
            ...
            var casualRemoveOperation = new CasualMSTeamOperation
            {
                OfferingId = offering.Id,
                CasualId = cover.CasualId,
                CoverId = cover.Id,
