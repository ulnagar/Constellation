...
{
    public class AdobeConnectGateway : IAdobeConnectGateway, IScopedService
    {
        ...
        public AdobeConnectGateway(IAdobeConnectGatewayConfiguration settings)
        {
            _settings = settings;
        ...
        private async Task Login()
        {
            ...
            if (cookie == null)
                throw new System.Exception("Could not log in to Adobe Connect");
        ...
        private async Task<T> Request<T>(string action, NameValueCollection queryParams) where T : AdobeConnectGateway.ResponseDto
        {
            await CheckLogin();
