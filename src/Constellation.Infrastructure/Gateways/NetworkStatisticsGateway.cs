...
{
    public class NetworkStatisticsGateway : INetworkStatisticsGateway, IScopedService
    {
        private readonly HttpClient _client;
        private string _urlBase;


        public NetworkStatisticsGateway(INetworkStatisticsGatewayConfiguration settings)
        {
        ...
        public async Task GetSiteUsage(NetworkStatisticsSiteDto site, int day = 0)
        {
            ...
            var targetDate = DateTime.Today.AddDays((int)day);
