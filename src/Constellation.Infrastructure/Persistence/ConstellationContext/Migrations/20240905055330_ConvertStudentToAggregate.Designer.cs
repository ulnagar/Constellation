...
namespace Constellation.Infrastructure.Persistence.ConstellationContext.Migrations
{
    ...
    [Migration("20240905055330_ConvertStudentToAggregate")]
    partial class ConvertStudentToAggregate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Constellation.Core.Models.Students.SystemLink", b =>
                {
                    b.Property<Guid>("StudentId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Constellation.Core.Models.Operations.UpdateUserEmailCanvasOperation", b =>
                {
                    ...
                    b.ToTable("CanvasOperations", t =>
                        {
                            t.Property("PortalUsername")
                                .HasColumnName("UpdateUserEmailCanvasOperation_PortalUsername");
                        });
            ...
            modelBuilder.Entity("Constellation.Core.Models.Families.StudentFamilyMembership", b =>
                {
                    ...
                    b.OwnsOne("Constellation.Core.Models.Students.ValueObjects.StudentReferenceNumber", "StudentReferenceNumber", b1 =>
                        {
                            b1.Property<Guid>("StudentFamilyMembershipFamilyId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<Guid>("StudentFamilyMembershipStudentId")
                                .HasColumnType("uniqueidentifier");

                            b1.HasKey("StudentFamilyMembershipFamilyId", "StudentFamilyMembershipStudentId");

                            b1.ToTable("Families_StudentMemberships");

                            b1.WithOwner()
                                .HasForeignKey("StudentFamilyMembershipFamilyId", "StudentFamilyMembershipStudentId");
                        });

                    b.Navigation("StudentReferenceNumber")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Constellation.Core.Models.Students.Student", b =>
                {
                    ...
                    b.OwnsOne("Constellation.Core.ValueObjects.Name", "Name", b1 =>
                        {
                            b1.Property<Guid>("StudentId")
                                .HasColumnType("uniqueidentifier");
