...
{
    /// <inheritdoc />
    public partial class AddSendingModuleToMessagingHistoryIndex : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                                 ALTER VIEW Messages.MessagingHistoryIndex AS
                                 SELECT
                                     e.Id,
                                     ...
                                     e.SendingModule AS SendingModule,
                                     (
                                 ...
                                 SELECT
                                     ...
                                     s.SendingModule AS SendingModule,
