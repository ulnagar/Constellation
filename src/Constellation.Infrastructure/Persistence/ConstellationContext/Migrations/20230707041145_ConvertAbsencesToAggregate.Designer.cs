...
namespace Constellation.Infrastructure.Persistence.ConstellationContext.Migrations
{
    ...
    [Migration("20230707041145_ConvertAbsencesToAggregate")]
    partial class ConvertAbsencesToAggregate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbsenceClassworkNotification", b =>
                {
                    ...
                    b.Property<Guid>("ClassworkNotificationId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("AbsencesId", "ClassworkNotificationId");

                    b.HasIndex("ClassworkNotificationId");
            ...
            modelBuilder.Entity("ClassworkNotificationStaff", b =>
                {
                    ...
                    b.HasKey("ClassworkNotificationId", "TeachersStaffId");
            ...
            modelBuilder.Entity("Constellation.Core.Models.MissedWork.ClassworkNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MissedWork_ClassworkNotifications", (string)null);
                });
            ...
            modelBuilder.Entity("AbsenceClassworkNotification", b =>
                {
                    ...
                    b.HasOne("Constellation.Core.Models.MissedWork.ClassworkNotification", null)
                        .WithMany()
                        .HasForeignKey("ClassworkNotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Constellation.Core.Models.Assignments.CanvasAssignment", b =>
                {
                    b.HasOne("Constellation.Core.Models.Course", null)
                        .WithMany()
