...
{
    public class Gateway : ILinkShortenerGateway, IScopedService
    {
        ...
        public Gateway(ILinkShortenerGatewayConfiguration settings, ILogger<ILinkShortenerGateway> logger)
        {
            _settings = settings;
            _logger = logger;
