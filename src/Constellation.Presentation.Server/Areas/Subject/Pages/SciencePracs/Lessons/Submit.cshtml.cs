...
public class SubmitModel : BasePageModel
{
    ...
    public async Task OnGet()
    {
        ...
        if (rollRequest.IsFailure)
        {
            Error = new()
            {
                ...
                RedirectPath = _linkGenerator.GetPathByPage("/SciencePracs/Lessons/Roll", values: new { area = "Subject", lessonId = LessonId, rollId = RollId })
            };
    ...
    public async Task<IActionResult> OnPostSubmit()
    {
        ...
        return RedirectToPage("/SciencePracs/Lessons/Roll", new { area = "Subject", lessonId = LessonId, rollId = RollId });
    }
