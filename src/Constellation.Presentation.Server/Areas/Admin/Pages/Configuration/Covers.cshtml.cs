...
public class CoversModel : BasePageModel
{
    ...
    [BindProperty] public string ContactPhone { get; set; } = string.Empty;
    ...
    {
        CoversConfiguration? configuration = await _appSettings.Covers();
    ...
    public async Task<IActionResult> OnPostSave()
    {
        ...
        await _appSettings.Covers(configuration);
