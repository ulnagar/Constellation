...
SELECT Id, FirstName, LastName, PortalUsername, IsDeleted, DateDeleted AS datetime2, DateEntered AS datetime2, AdobeConnectPrincipalId, SchoolCode FROM [ACOS].[dbo].[Casuals]
WHERE 1 = 1;
...
SELECT Id, SchoolContactId, Role, SchoolCode, IsDeleted, DateEntered AS datetime2, DateDeleted AS datetime2 FROM [ACOS].[dbo].[SchoolContactRole]
WHERE 1 = 1;
...
SELECT StudentId, FirstName, LastName, PortalUsername, AdobeConnectPrincipalId, SentralStudentId, CurrentGrade, EnrolledGrade, Gender, IsDeleted, DateDeleted AS datetime2, DateEntered AS datetime2, SchoolCode, IncludeInAbsenceNotifications, AbsenceNotificationStartDate AS datetime2 FROM [ACOS].[dbo].[Students]
WHERE 1 = 1;
...
SELECT StaffId, FirstName, LastName, PortalUsername, AdobeConnectPrincipalId, Faculty, IsDeleted, DateDeleted AS datetime2, DateEntered AS datetime2, SchoolCode FROM [ACOS].[dbo].Staff
WHERE 1 = 1;
...
SELECT Id, SerialNumber, DateEntered AS datetime2, Details FROM [ACOS].[dbo].[DeviceNotes]
WHERE 1 = 1;
...
SELECT Id, LessonId, SchoolCode, SchoolContactId, LessonDate AS datetime2, SubmittedDate AS datetime2, Comment, Status FROM [ACOS].[dbo].[LessonRolls]
WHERE 1 = 1;
