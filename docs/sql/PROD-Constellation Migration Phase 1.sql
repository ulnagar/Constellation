...
SELECT Id, FirstName, LastName, EmailAddress, PhoneNumber, IsDeleted, DateDeleted AS datetime2, DateEntered AS datetime2, SelfRegistered FROM [ACOS].[dbo].[SchoolContact]
WHERE 1 = 1;
...
SELECT Id, Timetable, Day, Period, StartTime, EndTime, Name, Type, IsDeleted, DateDeleted AS datetime2 FROM [ACOS].[dbo].[TimetablePeriods]
WHERE 1 = 1;
...
SELECT SerialNumber, Make, Model, Description, Status, DateWarrantyExpires AS datetime2, DateReceived AS datetime2, DateDisposed AS datetime2 FROM [ACOS].[dbo].[Devices]
WHERE 1 = 1;
...
SELECT Id, Name, DueDate AS datetime2, DoNotGenerateRolls FROM [ACOS].[dbo].Lessons
WHERE 1 = 1;
...
SELECT ScoId, Name, UrlPath, IsDeleted, DateDeleted AS datetime2, Protected FROM [ACOS].[dbo].[AdobeConnectRooms]
WHERE 1 = 1;
