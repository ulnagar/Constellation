namespace Constellation.Presentation.Staff.Areas.ShortTerm.Pages.Casuals;

using Application.Casuals.DeleteCasual;
using Application.Casuals.GetActiveCasuals;
using Application.Casuals.GetAllCasuals;
using Application.Casuals.GetInactiveCasuals;
using Application.Casuals.Models;
using Application.Casuals.RestoreCasual;
