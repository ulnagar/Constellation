namespace Constellation.Presentation.Staff.Areas.SchoolAdmin.Pages.Consent.Applications;
...
public class DetailsModel : BasePageModel
{
    ...
    public async Task OnGet()
    {
        ...
        if (applicationRequest.IsFailure)
        {
            Error = new()
            {
                ...
                RedirectPath = _linkGenerator.GetPathByPage("/Consent/Applications/Index", values: new { area = "SchoolAdmin" })
            };
    ...
    public async Task<IActionResult> OnGetDeactivate()
    {
        ...
        if (applicationRequest.IsFailure)
        {
            ...
            {
                Error = applicationRequest.Error,
                RedirectPath = _linkGenerator.GetPathByPage("/Consent/Applications/Details", values: new { area = "SchoolAdmin", Id = Id })
            };
